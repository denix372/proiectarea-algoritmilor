# 🧠 Dynamic Programming — Complete Roadmap (149 Problems)

This is the complete checklist for all DP problems, organized by phase, with links to sources (LeetCode, GFG, CSES)
...
- [ ] **Minimum Cost Tickets** — https://leetcode.com/problems/minimum-cost-for-tickets/
...
- [ ] **Climbing Stairs (3 Moves)** — https://www.geeksforgeeks.org/count-ways-to-reach-the-nth-stair/
...
- [ ] **Water Overflow** — https://www.geeksforgeeks.org/water-overflow/
...
- [ ] **Arrange Balls** — GFG Medium

---

# **Phase 2 — DP on Grids (15 problems)**
...
# **Phase 3 — DP on Strings (17 problems)**
...
- [ ] **Min Cost to Sort Strings by Reversals** — GFG Hard
- [ ] **Longest Repeating Non‑Overlapping Substring** — GFG Trees

---

# **Phase 4 — Distinct Ways / Combinatorics (21 problems)**

### 🔥 Standard
- [ ] **Fill n×4 Grid with 1×4 Tiles** — GFG
- [ ] **Dice Combinations** — https://cses.fi/problemset/task/1633
- [ ] **Combination Sum IV** — https://leetcode.com/problems/combination-sum-iv/
- [ ] **Binomial Coefficient** — https://www.geeksforgeeks.org/binomial-coefficient-dp-9/
- [ ] **Count Valid Parenthesis** — https://www.geeksforgeeks.org/count-possible-ways-to-construct-buildings/
...
- [ ] **Nth Row Pascal** — https://www.geeksforgeeks.org/find-nth-row-pascal-triangle/
...
- [ ] **Ways to Partition a Set** — https://www.geeksforgeeks.org/partition-a-set-into-two-subsets-such-that-difference-of-subset-sums-is-minimum/
- [ ] **Permutations with K Inversions** — GFG

---

# **Phase 5 — Knapsack Patterns (21 problems)**
...
# **Phase 6 — LIS Variants (15 problems)**
...
- [ ] **Min Swaps Increasing** — https://leetcode.com/problems/minimum-swaps-to-make-sequences-increasing/
...
# **Phase 8 — Interval DP (18 problems)**
...
### 🧩 Practice
- [ ] **Boolean Parenthesization** — GFG Hard
...
# **Phase 9 — Advanced DP (11 problems)**

### 🔥 Standard
- [ ] **Digit DP** — https://www.geeksforgeeks.org/digit-dp-introduction/
- [ ] **Traveling Salesman** — https://www.geeksforgeeks.org/travelling-salesman-problem-dp-18/
...
- [ ] **Max Height of Tree** — GFG Trees

### 🌀 Niche
- [ ] **Counting Tilings** — https://cses.fi/problemset/task/2181
- [ ] **SOS DP** — https://www.geeksforgeeks.org/sum-of-subsets-dynamic-programming/
